...
--	{ 8,	eSpecialAttack,					INKE_KeyUp,	1,				"Special Attack",						{ keySpecialAttackModifier},7},-- this binding must be linked to id 7 because it shares the same keyCombo
	...
	-- affects GUI screens closing as well
...
--	{ 142, 	"UI_ToggleScreenGameRubrick( 'InGameMenu', 'SpeechRecall', 0, gr_all)",				INKE_KeyDown,	0, 	"$5428", 		{ CONTROLKEY, KKEY } },
	...
	--------------------------------------------------------------------------------
	-- todo: need one for the dialogue button too, maybe, once I assign a hotkey to it
	{ 2,	ExitGameMouseClick,								INKE_KeyDown,	0,	"$5300",		{ ALTKEY, F4KEY} },
	{ 129,	LoadGameMouseClick,								INKE_KeyDown,	1,	"$5415",		{ CONTROLKEY, F8KEY } },
	{ 137, 	ObjectivesListScreenToggle,							INKE_KeyDown,	0,	"$5423", 		{ OKEY } },
	{ 142, 	SpeechRecallScreenToggle,							INKE_KeyDown,	0, 	"$5428", 		{ CONTROLKEY, KKEY } },
	{ 175,	SectorMapScreenToggle,								INKE_KeyDown,	0,	"Sector Map",		{ BACKSLASHKEY } },
	{ 176,	SquadMenuScreenToggle,								INKE_KeyDown,	0,	"Squad Menu",		{ CONTROLKEY, BACKSLASHKEY } },
	-- todo: works okay on the windows I specify, but the Build, Research, etc. windows don't close any more
--	{ 18,	CloseQueueOfWindows,								INKE_KeyDown,	1,	"$5316",		{ ESCKEY }},
	--------------------------------------------------------------------------------
