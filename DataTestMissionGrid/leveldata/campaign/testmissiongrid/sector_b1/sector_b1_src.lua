...
function Rule_Init()
	StartMission()
	if (questsStatus.b1_ModuleHasBeenBuilt ~= 1) then
...
function Rule_PlayerWins()
	if (SobGroup_HasSubsystem("Player_Ships0", "hgn_ms_production_fighter") == 1) then
		questsStatus.b1_ModuleHasBeenBuilt = 1
...
{ 
	...
	{ 
		HW2_SubTitleEvent( Actor_FleetCommand, sectorName, 5 ), 
	}, 
	{
		HW2_Wait( 1 ), 
	}, 
