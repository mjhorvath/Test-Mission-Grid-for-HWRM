...
BTN_SAVEGAME		= NewMenuButton("m_btnSave",		"$5564",	"$5550",	0,	LAYOUT_BUTTONS,	nil,	"FE_SaveGameScreen()",		1)
BTN_LOADGAME		= NewMenuButton("m_btnLoad",		"$5565",	"$5551",	0,	LAYOUT_BUTTONS,	nil,	"FE_LoadGameScreen()",		1)
BTN_SAVEGAME_CAMPAIGN	= NewMenuButton("m_btnSaveCampaign",	"$5566",	"$5552",	0,	LAYOUT_BUTTONS,	nil,	"FE_SaveGameScreen_Campaign()",	1)
BTN_LOADGAME_CAMPAIGN	= NewMenuButton("m_btnLoadCampaign",	"$5567",	"$5553",	0,	LAYOUT_BUTTONS,	nil,	"FE_LoadGameScreen_Campaign()",	1)
BTN_LOADGAME_RECORDED	= NewMenuButton("m_btnLoadRecorded",	"$5568",	"$5554",	0,	LAYOUT_BUTTONS,	nil,	"FE_LoadGameScreen_Recorded()",	1)
