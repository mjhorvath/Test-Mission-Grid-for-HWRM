...
--				onMouseClicked = "UI_ToggleScreen( 'ObjectivesList', 0)",
				onMouseClicked = ObjectivesListScreenToggle,
				helpTip = "$2744",
				helpTipTextLabel = "commandsHelpTip",
				hotKeyID = 137,
			},	
...
--				onMouseClicked = "UI_ToggleScreen( 'SpeechRecall', 0)",
				onMouseClicked = SpeechRecallScreenToggle,
				helpTip = "$2763", 
				helpTipTextLabel = "commandsHelpTip", 
				hotKeyID = 142, 
			},
			------------------------------------------------------------------------------------
			------------- START NEW MOD BUTTONS ------------------------------------------------
			------------------------------------------------------------------------------------
			{
				type = "TextButton",
				name = "btnSectorMap",
...
--				onMouseClicked = "UI_ToggleScreen( 'SectorMapScreenMinor', 0)",
				onMouseClicked = SectorMapScreenToggle,
				helpTip = "TOGGLE SECTOR MAP (Backslash)",
				helpTipTextLabel = "commandsHelpTip", 
				hotKeyID = 175,
			},
			{
...
--				onMouseClicked = "UI_ToggleScreen( 'SectorMapScreenMinor', 0)",
				...
				helpTip = "TOGGLE SQUAD MENU (Ctrl+Backslash)",
				helpTipTextLabel = "commandsHelpTip", 
				hotKeyID = 176,
			},
			------------------------------------------------------------------------------------
...
------------------- Tactical Groups 1-10 ---------------
		...
		--------Hide UI Button Frame...-----------
		{
			...
			--taskbar hide button		-- interesting
			{
				type = "Button",
				name = "btnHide1",
				helpTip = "$2738",
	...
	-- Floating dialogue button
	{
		type = "TextButton",
		Layout =
		{
			pivot_XY = { 0.5, 0.5 },
			pos_XY = { x = 0.5, y = 0.7, xr = "scr", yr = "scr" },
			size_WH = { w = 0.2, h = 0.05, wr = "scr", hr = "scr" },
		},
		buttonStyle = "FEButtonStyle1_Outlined",
		Text = 
		{
--			textStyle = "Taskbar_MenuButtonTextStyle",
			text = "",		-- gets updated dynamically based on the selected actor
		},
		name = "btnDialogue",
		onMouseClicked = DialogueScreenToggle,
		soundOnClicked = "SFX_ButtonClick",
		helpTip = "Click to engage in dialogue.",
		helpTipTextLabel = "commandsHelpTip",
		hotKeyID = 666,		-- todo: needs to be changed to something unique
		enabled = 1,
		visible = 0,
		autosize = 1,
	},
	-- Floating jump button
	{
		...
		buttonStyle = "FEButtonStyle1_Outlined",
		onMouseClicked = "MainUI_ScarEvent(\"JumpFromExitGrid()\")",
		soundOnClicked = "SFX_ButtonClick",
		helpTip = "Click to jump to the next sector.",
		helpTipTextLabel = "commandsHelpTip",
--		hotKeyID = 175,		-- only need one of these
		enabled = 0,		-- needs to be disabled by default!
		visible = 0,
		wrapping = 1,
		autosize = 1,
		;
