...
----------------------- Title Text Row -----------------------			
		{
			...
			-- Message Label
			{
					...
					Text = {
						text = "Save progress since last save? The game is also automatically saved when entering or leaving a sector.",
			...
			
			{
				...
				;
				{
					...
					;
					NewMenuButton("m_btnAccept",	"$5172",	"",	0,	BTN_FOOTER_SMALL_LAYOUT,	"FEButtonStyle1_Alert_Chipped",		SaveGameYes),
					NewMenuButton("m_btnCancel",	"$5171",	"",	0,	BTN_FOOTER_SMALL_LAYOUT,	"FEButtonStyle1",			SaveGameNo),
