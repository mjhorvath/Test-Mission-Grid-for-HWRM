...
worldLineColour                     = {0.64,0.46,0,1.0}                     --colour of world plane lines (will be scaled during zoom)
--worldPlaneColour                    = {0.5,0.5,0.5,0.2}                     --colour of the world plane (will be scaled during zoom-out)
--worldLineColour                     = {0.5,0.5,0.5,1.0}                     --colour of world plane lines (will be scaled during zoom)
