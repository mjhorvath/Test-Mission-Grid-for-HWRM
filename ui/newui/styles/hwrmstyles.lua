...
FEListBoxItemButtonStyle = 
	...
	-- START MOD STUFF
	------------------------------------------------------------------------------------
	FEListBoxItemTextStyle_RED = {
		type = "Text",
		font = "ButtonFont",
		color = {255,191,191,255},
		vAlign = "Middle",
		hAlign = "Left",
		offset = {4,0},
	},
	FEListBoxItemTextStyle_GREEN = {
		type = "Text",
		font = "ButtonFont",
		color = {191,255,191,255},
		vAlign = "Middle",
		hAlign = "Left",
		offset = {4,0},
	},
	FEListBoxItemTextStyle_BLUE = {
		type = "Text",
		font = "ButtonFont",
	...
	FEButtonStyle1_CombatWarning = 
	{
		type = "Button",
		stateIconOfs = { 0.0, 32/256 },
		stateIconCells = { 0, 1, 2, 3, 4, 5, 6, 6 },
		Layout = {},
		IconBase =
		{
			size = {0, 0},
			texture = "DATA:UI\\NewUI\\Styles\\RM_Buttons_Patched_Flat.tga",
			uvRect = { 64/256, 0/256, 96/256, 32/256 },
			patch_X = { 12, -8, 12, 0 },
			patch_Y = { 12, -8, 12, 0 },
			patch_Scale = 1,		
			Surface =
