...
----------------------- Title Text Row -----------------------			
		{
			...
			-- Message Label
			{
					...
					Text = {
						text = "Reload last save? Any activity since the last save will be lost.",
			...
			
			{
				...
				;
				{
					...
					;
					NewMenuButton("m_btnAccept",	"$5172",	"",	0,	BTN_FOOTER_SMALL_LAYOUT,	"FEButtonStyle1_Alert_Chipped",		LoadGameYes),
					NewMenuButton("m_btnCancel",	"$5171",	"",	0,	BTN_FOOTER_SMALL_LAYOUT,	"FEButtonStyle1",			LoadGameNo),
