...
--				NewMenuButton("btnTutorial",	"$2602",	nil,		0,		LAYOUT_MENU_BUTTONS,	"FEButtonStyle1",	nil, 0, "btnCampaign", nil, nil, nil, nil),
				CampainButton(),
--				NewMenuButton("btnExtra",	"$2606",	nil,		0,		LAYOUT_MENU_BUTTONS,	"FEButtonStyle1",	nil, 0, nil, nil, nil, nil, nil),
				NewMenuButton("btnPlayerVsCPU",	"DELETE ME",	nil,		0,		LAYOUT_MENU_BUTTONS,	"FEButtonStyle1",	nil, 0, nil, nil, nil, nil, nil),
				MPButton(),
				...
				NewMenuButton("btnTestScreen",	"TEST SCREEN",	nil,		0,		LAYOUT_MENU_BUTTONS,	"FEButtonStyle1",	[[UI_SetNextScreen("StyleSheetTestScreen", "NewMainMenu");UI_SetPreviousScreen("StyleSheetTestScreen", "NewMainMenu");UI_ShowScreen("StyleSheetTestScreen", eTransition);]]),
