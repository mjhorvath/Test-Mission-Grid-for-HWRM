...
GameScreens =
{
	...
	------------------------------------------------------------------------------------
	-- START CUSTOM MOD SCREENS
	------------------------------------------------------------------------------------

	{
		name = "DialogueScreen",
		filename = "DATA:\\UI\\NewUI\\DialogueScreen.lua",
		activated = 0,
--		type = "UIDialog",
	},
	{
		name = "SectorMapScreenMinor",
		filename = "DATA:\\UI\\NewUI\\SectorMapScreenMinor.lua",
		activated = 0,
--		type = "UIDialog",
	},
	{
		name = "SectorMapScreenMajor",
		filename = "DATA:\\UI\\NewUI\\SectorMapScreenMajor.lua",
		activated = 0,
--		type = "UIDialog",
	},
	{
		name = "SquadMenuScreenMinor",
		filename = "DATA:\\UI\\NewUI\\squadmenuscreenminor.lua",
		activated = 0,
--		type = "UIDialog",
	},
	{
		name = "SquadMenuScreenMajor",
		filename = "DATA:\\UI\\NewUI\\squadmenuscreenmajor.lua",
		activated = 0,
--		type = "UIDialog",
	},
	{
		name = "ProgressSave",
		filename = "DATA:\\UI\\NewUI\\progresssave.lua",
		activated = 0,
--		type = "UIDialog",
	},
	{
		name = "ProgressLoad",
		filename = "DATA:\\UI\\NewUI\\progressload.lua",
		activated = 0,
--		type = "UIDialog",
	},
	{
		name = "ProgressExit",
		filename = "DATA:\\UI\\NewUI\\progressexit.lua",
		activated = 0,
--		type = "UIDialog",
	},

	------------------------------------------------------------------------------------
	-- END CUSTOM MOD SCREENS
	------------------------------------------------------------------------------------
}
