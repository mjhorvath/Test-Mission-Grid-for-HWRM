...
function Rule_Init()
	StartMission()
	if (questsStatus.a3_ShipHasBeenFound ~= 1) then
...
function Rule_PlayerWins()
	if (SobGroup_PlayerIsInSensorRange("EnyGroup", 0) == 1) then
		Ping_Remove(enemy_ping)
		questsStatus.a3_ShipHasBeenFound = 1
